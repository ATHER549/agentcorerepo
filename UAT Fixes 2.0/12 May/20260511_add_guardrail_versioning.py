...
def downgrade() -> None:
    ...
    if _has_column(bind, "guardrail_catalogue", "latest_version"):
        op.drop_column("guardrail_catalogue", "latest_version")

    if _table_exists(bind, "guardrail_version"):
        op.drop_table("guardrail_version")
