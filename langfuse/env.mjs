...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_AUTH_AZURE_AD_PUBLIC_CLIENT_ID: process.env.NEXT_PUBLIC_AUTH_AZURE_AD_PUBLIC_CLIENT_ID,
    NEXT_PUBLIC_AUTH_AZURE_AD_PUBLIC_TENANT_ID: process.env.NEXT_PUBLIC_AUTH_AZURE_AD_PUBLIC_TENANT_ID,
